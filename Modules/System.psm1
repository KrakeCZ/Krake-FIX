...
function Show-Win32PrioMenu {
    while ($true) {
        ...
        Write-Host ""
        Write-Host "════════════════════════════════════════════════" -ForegroundColor Cyan
        Write-Host "  AKTUÁLNÍ NASTAVENÍ (nevyžaduje restart)" -ForegroundColor Yellow
        Write-Host "════════════════════════════════════════════════" -ForegroundColor Cyan
        ...
        Write-Host ""
        Write-Host "═══════════════════════════════════════════════════════════════" -ForegroundColor White
        Write-Host " VÝBĚR PROFILU Win32PrioritySeparation (testuj během hry)" -ForegroundColor Yellow
        Write-Host "═══════════════════════════════════════════════════════════════" -ForegroundColor White
        Write-Host ""
        # ━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━
