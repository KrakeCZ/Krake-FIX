...
# • BSI4 compliant: Password protection, PIN confirmation, backup/restore
# • Based on @STUDY/39-Kernel-Security-Models.md
# • Based on @STUDY/19-LSASS-Protection-Credential-Guard.md
# ═══════════════════════════════════════════════════════════════════════════
...
.NOTES
    ...
    Per @STUDY/01-Privilege-Escalation-Deep-Dive.md
    Per @STUDY/39-Kernel-Security-Models.md
#>
...
.NOTES
    ZDROJ: KRAKE-FIX-v1.ps1 řádky 12971-13584
    ZÁVISLOST: Core.psm1 (Invoke-AsSystem)
#>
...
.NOTES
    Per @STUDY/31-Win32-API-Token-Process.md (P/Invoke patterns)
#>
...
.NOTES
    Based on KRAKE-FIX-v1.ps1 Invoke-HostsTelemetryRestore
#>
...
.NOTES
    Based on KRAKE-FIX-v1.ps1 function Show-SecurityHazardMenu
    Per @STUDY/39-Kernel-Security-Models.md (CPU mitigations)
    Per @STUDY/19-LSASS-Protection-Credential-Guard.md (LSA/VBS)
...
function Show-SecurityHazardMenu {
    ...
    while ($true) {
        ...
        # ← OPRAVA: Pause MIMO if blok, na konci while loop
        Write-Host ""
