...
function Invoke-TweakC {
    ...
    # ═══════════════════════════════════════════════════════════════════════
    Write-Host "FÁZE 2: VYPÍNÁM SCHEDULED TASKS (REDUKCE PROCESŮ)..." -ForegroundColor Yellow
    Write-Host ""
    Write-Host "  🔐 Spouštím s SYSTEM oprávněními..." -ForegroundColor Cyan
    ...
    Write-Host ""
    $serviceList = Get-TweakCServiceList
    ...
    # ═══════════════════════════════════════════════════════════════════════
    Write-Host "FÁZE 3: ODSTRAŇUJI APPX BALÍČKY (ULTRA - 90 balíčků)..." -ForegroundColor Yellow
    Write-Host ""
    ...
    # ❌ ODSTRANÍ:  Kalkulačka, Fotky, Kalendář, Xbox App, Xbox Identity
    # ❌ ODSTRANÍ: - Pokud si přidal! Store -
    ...
    Write-Host "  -> ⚠️  ODSTRANÍ:  Xbox, Kalkulačka, Fotky využij jiný prohlížeč!" -ForegroundColor Red
    ...
    # ═══════════════════════════════════════════════════════════════════════
    Write-Host "FÁZE 4: ODSTRAŇUJI MICROSOFT EDGE..." -ForegroundColor Magenta
    Write-Host ""
    try {
