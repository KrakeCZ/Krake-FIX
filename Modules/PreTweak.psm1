...
function Enable-PsExecDependencies {
    ...
    try {
        # ==================================================================
        # OPRAVA: Odstraněna přebytečná čárka z (,$requiredServices)
        # Přidán StartMode parametr pro ScriptBlock
        # ==================================================================
    ...
    while ($true) {
        ...
        switch ($choice.ToUpper()) {
            '1' {
                ...
                $result = Enable-PsExecDependencies -StartMode Automatic
            ...
            '2' {
                ...
                $result = Enable-PsExecDependencies -StartMode Manual
