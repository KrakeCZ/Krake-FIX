...
function Show-RevertMenu {
    ...
    while ($true) {
        ...
        Write-Host "--------------------------------------------------"
        Write-Host "[1]   Mitigace CPU (Spectre/Meltdown)"
        ...
        Write-Host "[5]   LSA Ochrana (Local Security Authority)"
        Write-Host "[6]   TSX Instrukce"
        ...
        Write-Host "[8]   'Full Admin Control' Menu"
