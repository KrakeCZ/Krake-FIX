# ═══════════════════════════════════════════════════════════════════════════
# Module: MEBlock.psm1 - Microsoft Edge Blockade & Intel ME Block
# ═══════════════════════════════════════════════════════════════════════════
...
# ═══════════════════════════════════════════════════════════════════════════
# Description:  Microsoft Edge blockade (Registry/IFEO/ACL) + Intel ME block
...
# • Based on @STUDY/02-Registry-Security-Deep-Dive.md
# • Based on @STUDY/13-UAC-Internals-Bypass.md (IFEO)
# • Based on @STUDY/15-ACL-Inheritance-DACL-SACL.md
# ═══════════════════════════════════════════════════════════════════════════
...
.NOTES
    Based on KRAKE-FIX-v1.ps1 function Invoke-EdgeBlockade
    Per @STUDY/02-Registry-Security-Deep-Dive.md (Registry security)
    Per @STUDY/13-UAC-Internals-Bypass.md (IFEO manipulation)
    Per @STUDY/15-ACL-Inheritance-DACL-SACL.md (ACL lock)
#>
