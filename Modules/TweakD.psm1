...
# ═══════════════════════════════════════════════════════════════════════════
#--- POKUD VYSLEDUJETE VYŠŠÍ DOBU PŘÍSTUPU , OKAMŽITĚ SE VRAŤ! 
# ═══════════════════════════════════════════════════════════════════════════
...
function Show-TweakDInfo {
    ...
    Write-Host "═══════════════════════════════════════════════════════════════" -ForegroundColor Cyan
    Write-Host "!POKUD VYSLEDUJETE VYŠŠÍ DOBU PŘÍSTUPU , OKAMŽITĚ SE VRAŤ ZPĚT! " -ForegroundColor Red
    Write-Host " " 
    ...
    Write-Host ""
    Write-Host " FSUTIL nemá negativní dopad.Naopak. "-ForegroundColor Red
    Write-Host ""
...
function Invoke-TweakD {
    ...
    while ($true) {
        ...
        Write-Host "═══════════════════════════════════════════════════════════════" -ForegroundColor Magenta
        Write-Host "!POKUD VYSLEDUJETE VYŠŠÍ DOBU PŘÍSTUPU NVMe tweaku, OKAMŽITĚ SE VRAŤ ZPĚT! " -ForegroundColor Red
        Write-Host ""
