...
.PARAMETER SkipBackup
    ...
    .NOTES
        ...
        Reference: Study Doc 17-Registry-WOW64-Virtualization.md
    #>
    [CmdletBinding(SupportsShouldProcess)]
    param(
        [Parameter(Mandatory)]
...
function Invoke-RestoreRegistry {
    ...
    .NOTES
        ...
        Reference: KRAKE-FIX v1 Restore-RegistryValue (line 2862-2911)
        Study: 02-Registry-Security-Deep-Dive.md, 03-Error-Handling-Fallback-Strategy.md
    #>
    [CmdletBinding()]
    param(
        [Parameter(Mandatory)]
...
function Test-RestoreReadiness {
    ...
    .NOTES
        Reference: @STUDY/03-Error-Handling-Fallback-Strategy.md
        Study: CRITICAL-RESTORE-SAFETY-PLAN.md

        ️ This check is MANDATORY before ANY restore operation!
    #>
    [CmdletBinding()]
    [OutputType([bool])]
    param(
