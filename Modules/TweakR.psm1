...
function Invoke-TweakR {
    ...
    Write-Host "═══════════════════════════════════════════════════════════════" -ForegroundColor Magenta
    Write-Host ""
    Write-Host " Edituj TWEAKR.psm1 pro libovolne nastavení služeb." -ForegroundColor Red
    ...
    if ($allServiceOperations | Where-Object { $_.ServiceName -in @('UsoSvc', 'WManSvc', 'DiagTrack', 'SysMain') }) {
        ...
        Write-Host "║  ⚠️  POZOR: Windows Update služby NEBYLY OBNOVENY!          ║" -ForegroundColor Red
        Write-Host "╚═══════════════════════════════════════════════════════════════╝" -ForegroundColor Yellow
        Write-Host ""
